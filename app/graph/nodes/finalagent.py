...
- Either the knowledge base (RAG response) and order information (order response) both
- Or only order information (order response).
...
class ResponseNode:
    def __init__(self) -> None:
        self.llm = ChatGroq(
            model=settings.final_model,  # type: ignore
